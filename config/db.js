...
const connectDB =async()=>{
    try{
        ...
        const connectionString = `mongodb+srv://sangeetadammu12:${password}@dev-cluster.wftp2.mongodb.net/?retryWrites=true&w=majority&appName=dev-cluster`; // clustore url
